...
export const zhCN = {
  ...
  commentConfig: {
    ...
    loadFailed: "加载配置失败",
    basicSettings: "基础设置",
    basicSettingsDesc: "选择新评论的审核方式；全部关闭时，评论将立即发布",
    manualReview: "人工审核",
    manualReviewDesc: "所有新评论先进入审核队列，由管理员通过或拒绝",
    keywordFilter: "关键词过滤",
    keywordFilterDesc: "包含屏蔽关键词的评论将被自动拒绝",
    llmReview: "大模型审核",
    llmReviewDesc:
      "将新评论发送到配置的大模型进行审核；审核失败时评论将进入人工审核队列",
    switchesHint:
      "关键词过滤和大模型审核只能拒绝评论——开启人工审核时，一切以人工终审为准",
    testConnection: "测试连接",
    testing: "测试中...",
    testConnectionHint: "使用已保存的大模型配置发送一条测试评论",
    testFailed: "大模型审核测试失败",
    apiConfig: "API配置",
  ...
  generalSettings: {
    ...
    siteLanguage: "站点语言",
    siteLanguageDesc: "公开主题的默认语言，访客仍可用 ?lang= 临时切换。",
    siteLanguageEn: "English",
    siteLanguageZh: "简体中文",
    siteLanguageMissing: "当前主题未提供该语言，缺失的文案将回退为英文显示。",
    captcha: "滑块验证",
  ...
  adminData: {
    ...
    add: "添加",
    postCount: "{count} 篇文章",
    inUseHint: "仍被文章使用的项目无法删除",
    tagsHint: "标签由文章自动创建，仅未被任何文章使用的标签可以删除。",
    deleteCategory: "删除分类",
    deleteTag: "删除标签",
    actionFailed: "操作失败",
    noRecords: "暂无记录",
  ...
  pageEditorPage: {
    ...
    slug: "URL 别名",
    slugRequired: "请输入 URL 别名",
    slugInvalid: "别名仅允许小写字母、数字和连字符，且不能是保留词",
    slugReserved: "该别名被系统保留",
    slugTaken: "该别名已被其他页面占用",
    generateSlug: "从标题生成",
    status: "状态",
    draft: "草稿",
    published: "已发布",
  ...
  editor: {
    ...
    imageUrlRequired: "请填写图片地址",
    imageAlt: "替代文本",
    imageAltPlaceholder: "图片无法显示时的说明文字",
    linkTitle: "插入链接",
    linkText: "链接文字",
    linkTextPlaceholder: "显示的文字",
    linkUrl: "链接地址",
    linkUrlPlaceholder: "https://example.com",
    linkUrlRequired: "请填写链接地址",
  },
};
