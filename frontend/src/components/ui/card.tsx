...
/**
 * A card is a hairline panel on the paper canvas — squared, no shadow, no
 * gradient. Structure inside the panel comes from type and rules, so the
 * panel itself stays as quiet as possible.
 */
...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "display text-subtitle leading-snug text-foreground",
        className,
      )}
      {...props}
    />
